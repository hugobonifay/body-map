...
const BodyMap = () => {
    ...
    const handleChange = newValue => {
        setState(state => state.includes(newValue) ? state.filter(d => d !== newValue) : [...state, newValue] )
    }
    ...
    return (
        <div>
            ...
            <div className="human-body">
                ...
                {/* TETE */}
                <svg onClick={()=>handleChange("tête")} data-position='head' id='head' className='part head' xmlns='http://www.w3.org/2000/svg' width='56.594' height='95.031' viewBox='0 0 56.594 95.031'>
                ...
                {/* EPAULE GAUCHE */}
                <svg onClick={()=>handleChange("épaule gauche")} data-position='left-shoulder' id='left-shoulder' className='part left-shoulder' xmlns='http://www.w3.org/2000/svg' width='109.532' height='46.594' viewBox='0 0 109.532 46.594'>
                ...
                {/* EPAULE DROITE */}
                <svg onClick={()=>handleChange("épaule droite")} data-position='right-shoulder' id='right-shoulder' className='part right-shoulder' xmlns='http://www.w3.org/2000/svg' width='109.532' height='46.594' viewBox='0 0 109.532 46.594'>
                ...
                <svg onClick={()=>handleChange("bras gauche")} data-position='left-arm' id='left-arm' className='part left-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
                ...
                <svg data-position='right-arm' id='right-arm' className='part right-arm' xmlns='http://www.w3.org/2000/svg' width='156.344' height='119.25' viewBox='0 0 156.344 119.25'>
                ...
                <svg data-position='chest' id='chest' className='part chest' xmlns='http://www.w3.org/2000/svg' width='86.594' height='45.063' viewBox='0 0 86.594 45.063'>
                ...
                <svg data-position='stomach' id='stomach' className='part stomach' xmlns='http://www.w3.org/2000/svg' width='75.25' height='107.594' viewBox='0 0 75.25 107.594'>
                ...
                <svg data-position='left-leg' id='left-leg' className='part left-leg' xmlns='http://www.w3.org/2000/svg' width='93.626' height='250.625' viewBox='0 0 93.626 250.625'>
                ...
                <svg data-position='right-leg' id='right-leg' className='part right-leg' xmlns='http://www.w3.org/2000/svg' width='80' height='250.625' viewBox='0 0 80 250.625'>
                ...
                <svg data-position='left-hand' id='left-hand' className='part left-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                ...
                <svg data-position='right-hand' id='right-hand' className='part right-hand' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
                ...
                <svg data-position='left-foot' id='left-foot' className='part left-foot' xmlns='http://www.w3.org/2000/svg' width='30' height='30' viewBox='0 0 30 30'>
                ...
                <svg data-position='right-foot' id='right-foot' className='part right-foot' xmlns='http://www.w3.org/2000/svg' width='90' height='38.938' viewBox='0 0 90 38.938'>
